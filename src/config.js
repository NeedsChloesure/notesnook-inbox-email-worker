...
export const ATTACHMENT_SIZE_LIMIT = 5 * 1024 * 1024; // 5 MiB // the multiplication by 1.4 is to prevent attachments that are base64-ified from becoming "too large".
